...
$locationQuery = "SELECT DISTINCT location FROM lost_items WHERE item_type='identification'";
$locationResult = $conn->query($locationQuery);

// Fetch items
$sql = "SELECT itemName, location, date_time, image, description FROM lost_items WHERE item_type='identification'";
...
<body>
    ...
    <div class="title-container">
        <h1>Lost Identification Cards</h1>
    </div>
