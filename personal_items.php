...
$locationQuery = "SELECT DISTINCT location FROM lost_items WHERE item_type='personal'";
$locationResult = $conn->query($locationQuery);

// Fetch items
$sql = "SELECT itemName, location, date_time, image, description FROM lost_items WHERE item_type='personal'";
